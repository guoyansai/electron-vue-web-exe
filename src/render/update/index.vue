...
export default {
  ...
  methods: {
    ...
    getOnlineVersion() {
      ...
      let verUrl =
        "https://gitee.com/guoyansai/electron-vue-web-exe/blob/master/update.json";
      verUrl = "update.json";
      axios
        .get(verUrl)
        .then((res) => {
    ...
    downloadResource() {
      ...
      axios({
        ...
        .then((res) => {
          ...
          // 存储的文件名称，自定义格式
          const fileName = `electron-vue-web-exe-${
            this.setup.versionType
          }-v${this.onlineVersion.join(".")}${ext}`;
          // 系统临时文件夹
